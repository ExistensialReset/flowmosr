...
## 5.2 Decay (Anti-Accumulation Principle)
...
# 7. OPTIONAL RESOURCE ALLOCATION

SRS may gently influence access to limited, non-essential experiences.
...
# 9. NO NEGATIVE SCORING

SRS only expresses appreciation.
...
SRS is experimental and revocable.
