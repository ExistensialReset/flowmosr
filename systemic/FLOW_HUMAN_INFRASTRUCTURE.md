...
```mermaid
flowchart TB
    Baseline[Baseline: Essential resources] --> Refugium[Refugium Anima: Recovery & Safety]
    Refugium --> Lyceum[Lyceum Musaeum: Knowledge & Creation]
    Lyceum --> HeavyWork[Heavy Work / Task Rotation]
