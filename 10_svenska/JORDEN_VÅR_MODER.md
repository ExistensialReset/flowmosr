...
> "Vår frihet mäts i den motståndskraft vi bevarar i de system som stödjer allt liv."

---

## 2. De Inre Systemen: Organ och Vätskor
Vi erkänner att Jordens kropp består av sammankopplade system som inte kan utvinnas utan konsekvens.

* **De Djupa Vätskorna (Olja och Gas):** Dessa är del av Jordens inre trycksystem. Att utvinna dem i människohastighet urholkar skorpans strukturella integritet.
* **Njurarna (Våtmarker):** Det systematiska dränerandet av våtmarker är förstörelsen av Jordens filtreringssystem. 
* **Lungorna (Urskog):** Uråldriga skogar är planetens kyl- och andningsmekanismer. Att förlora 20% av Amazonas är att leva i en kropp med sviktande lungor.
...
## 4. Praktiskt Motstånd: Omsorgens Ritual
Eftersom utvinning är en våldshandling väljer vi bevarandets och reparationens väg.
...
## 5. Febern (Termisk Integritet)
Vi erkänner stigande global temperatur som ett tecken på systemisk stress. Vi förhandlar inte med febern. Vi justerar vår hastighet till Hennes kylkapacitet.

---

## 6. Tillgänglighet och Rörelse
När vi av-asfalterear och återför mark till Modern gör vi det med medfödd empati (I). 
* Rörelsevägar för rullstolar och rörelsehjälpmedel förblir släta och prioriterade. 
* Sann vildhet inkluderar oss alla; det är ett utrymme där varje kropp hör hemma.

---

**VERSION:** 2.4 (Tacksamhetsuppdatering)
