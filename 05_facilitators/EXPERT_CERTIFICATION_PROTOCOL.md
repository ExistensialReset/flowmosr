...
## Version 3.0 – Reality-Resilient Design
...
> "Expertise informs decisions. The system protects against both ignorance and dominance."

**V3 Focus:**
- Remove hidden expert power (framing control)
- Reduce cognitive load on community
- Prevent expert burnout
- Adapt process to decision complexity
...
Expertise grants structured responsibility within constrained influence.**
...
1. **Problem Framing Layer (NEW)**
2. **Expert Analysis Layer**
3. **Decision Layer (LOTUS + Community)**

👉 **Key Change in V3:**
Experts no longer control the *entry point* of decisions.

---

# MECHANISM 0: PROBLEM FRAMING (CRITICAL ADDITION)
...
## Structure: Dual-Origin Framing

Every decision begins from TWO parallel inputs:

### 1. Community Framing
- Open submission: “What is the problem?”
- Multiple framings allowed
- Simplified language required

### 2. Expert Framing
- Technical definition of the issue
- Constraints, known risks, system context

---

## Synthesis Step (NEW ROLE)
...
# MECHANISM 1: ADAPTIVE PROCESS TIERS
...
# MECHANISM 2: EXPERT ROLE REDEFINED
...
# MECHANISM 4: COGNITIVE LOAD REDUCTION
...
# MECHANISM 6: EXPERT SUSTAINABILITY
