...
- Base requirement: **30 kcal per kg of body weight per day**  
- Adjusted for sustained activity (physical or mental labor): +20%  
...
| Moderate activity | 2,520 kcal |
| High activity | 3,024 kcal |

**Children:**

- Base requirement: **35 kcal per kg of body weight per day**  
- Adjusted for sustained activity or growth periods: +20%  

**Example (Child 30 kg):**

| Activity Level | kcal/day |
|----------------|----------|
| Sedentary | 1,050 kcal |
| Moderate activity | 1,260 kcal |
| High activity | 1,512 kcal |
...
**Note:** This is survival + stability, not performance optimization.
...
If the medical condition requires it, the Baseline must be extended.  
...
# XI. BASELINE TRAVEL & EXPLORATION

**Principle:** All individuals aged **7–25 years** are guaranteed at least **two extended trips** during this period to explore the world, cultures, and natural environments.  

**Standards:**

- **Transport:** Preferably non-air travel (train, boat, bus, bicycle)  
- **Duration:** Minimum 5–10 days per trip  
- **Safety:** Age-appropriate and adapted for physical or mental needs  
- **Purpose:** Exploration, learning, cultural & natural exposure  
- **Funding:** Fully guaranteed by Baseline — individuals do not pay  

**Goals:**

- Broaden perspectives and curiosity  
- Strengthen independence and comfort in new environments  
- Create shared experiences as part of Baseline  

**Adjustments:**

- Additional support/resources for individuals with special needs (assistants, adaptive equipment)  
- Trips may include practical projects, volunteering, nature or adventure experiences  
...
Travel, exploration, and learning are **integral parts** of Baseline for young individuals.  
Energy requirements are **weight- and activity-adjusted** to ensure survival, stability, and functional growth.
